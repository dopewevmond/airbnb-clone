      ...
      <div className="container">
        <RowFlexContainerSpacedBetween>
          ...
          <ColFlexContainer>
            ...
            <Dropdown onClick={() => { toggleDropdown(!isDropdownOpen) }}>
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
